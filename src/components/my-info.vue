<template>
    <div class="lg:tw-flex md:tw-flex-row tw-w-full tw-flex-col tw-items-center">
        <div class="md:tw-w-2/5 lg:tw-w-2/5 xs::tw-w-full sm:tw-w-full tw-text-tertiary py-26 md:tw-text-6xl tw-text-xl tw-flex tw-flex-col tw-items-end tw-pr-12">
            <p> About Me </p>
            <hr id="hr" style="height: 3px; width: 100px; border: none; color: #FBD214; background-color: #FBD214;" class="tw-mt-2" />
        </div>
        <div class="md:tw-w-3/5 lg:tw-w-3/5 xs::tw-w-full sm:tw-w-full tw-mx-auto tw-bg-tertiary tw-flex tw-p-14 lg:tw-p-20 xs:tw-p-10 sm:tw-p-10 tw-content-start tw-text-justify">
